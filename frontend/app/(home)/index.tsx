...
function UserCard({ user }: { user: UserInfo }) {
  ...
  return (
    ...
    >
      ...
      <Text style={{ marginTop: 10, color: "#0A66C2", fontWeight: "700" }}>
...
export default function Home() {
  ...
  const takePhoto = async () => {
    ...
    if (status !== "granted") {
      Alert.alert("Permiso requerido", "Necesitas habilitar acceso a la cámara.");
      return;
    }
  ...
  const pickFromGallery = async () => {
    ...
    if (status !== "granted") {
      Alert.alert("Permiso requerido", "Necesitas habilitar acceso a la galería.");
      return;
    }
      ...
      <View style={{ marginTop: 10 }}>
        ...
        {als.map((it, idx) => (
          ...
          >
            ...
            <Text>
              Prot: {fmtNum(it?.proteinas_g)} g · Carb: {fmtNum(it?.carbohidratos_g)} g · Grasas:{" "}
      ...
      >
        ...
        >
          ...
          >
            ...
            <Text style={{ color: "#D1D5DB", marginTop: 4, fontSize: 12 }}>
      ...
      <View style={{ flex: 1, backgroundColor: "#fff" }}>
        ...
        >
          <Text style={{ fontSize: 18, fontWeight: "700" }}>
            Bienvenido a Nutri APP
          </Text>
          {session && (
        <Text style={{ color: "#000" }}>User ID: {session.user.id}</Text>
          )}
